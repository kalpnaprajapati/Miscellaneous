...
Label(root, text ='Times New Roman', font = 'arial 20 bold').pack(side =BOTTOM)
...
#Function for users to choose to encode or decode
def Mode():
    if(mode.get() == 'e'):
...
#playing the code in loop or reseting
def Reset():
    Text.set("")
    private_key.set("")
    mode.set("")

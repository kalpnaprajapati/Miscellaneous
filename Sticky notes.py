...
#Notes Title input
notes_title_label = Label(window, text="Notes title:").place(x=10,y=80)
notes_title_entry = Entry(window,  width=20)
notes_title_entry.place(x=80,y=50)
#Notes input
notes_label = Label(window, text="Notes:").place(x=10,y=150)
notes_entry = Text(window, width=50,height=5)
notes_entry.place(x=60,y=90)
 
#Perform notes functions
button1 = Button(window,text='Add This Note', bg = 'HotPink1',fg='snow',command=add_notes).place(x=10,y=220)
button2 = Button(window,text='View your Notes', bg = 'HotPink1',fg='snow',command=view_notes).place(x=110,y=220)
button3 = Button(window,text='Delete Notes', bg = 'HotPink1',fg='snow',command=delete_notes).place(x=210,y=220)
button4 = Button(window,text='Update Notes', bg = 'HotPink1',fg='snow',command=update_notes).place(x=320,y=220)
